...
export default () => new Promise(async (resolve, reject) => {
  try {
    ...
    skillsResolversNlp.settings.modelFileName = SKILLS_RESOLVERS_NLP_MODEL_PATH
    ...
    try {
      ...
      LogHelper.success(`Global resolvers NLP model saved in ${GLOBAL_RESOLVERS_NLP_MODEL_PATH}`)
      resolve()
    } catch (e) {
